...
from backend.api.companies.models import Company, CompanyJobPosition
from backend.api.companies.serializers import (
    CompanyDetailSerializer,
    CompanySerializer,
    JobPositionSerializer,
)
from backend.api.users.permissions import IsCompanyAdmin, IsOwnerOrAdmin
